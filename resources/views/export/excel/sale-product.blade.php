<table>
    <thead>
        ...
        <tr>
            <td width="20px"></td>
            <td style="font-size:16px; font-weight:500;">LAPORAN PENJUALAN PRODUK</td>
        </tr>
        <tr>
            <td width="20px"></td>
...
<table>
    ...
    <tfoot>
        <tr>
            ...
            <td style="border: 1px solid black; text-align: center; font-weight: bold;">{{ $sales->sum('total_items') }}</td>
        </tr>
    </tfoot>
</table>
