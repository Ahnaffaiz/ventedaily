            ...
            <div class="p-6">
                <div class="flex justify-between">
                    <div class="overflow-hidden grow">
                        <h5 class="mt-0 text-base font-normal text-gray-600" title="Number of Customers">All Keeps</h5>
                        <h3 class="my-6 text-2xl">Rp. {{ number_format($all_keep_price, 0, ',', '.') }}</h3>
                        <p class="text-gray-400 truncate">
                            <span class="bg-primary rounded-md text-md px-1.5 py-0.5 text-white me-1">{{ $all_keep_products }}</span>
                            <span>Product</span>
                        </p>
                    </div>
                </div>
