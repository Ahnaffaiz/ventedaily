<div>
    ...
    <x-modal wire:model="isOpen" title="{{ $title }}"
        ...
        <form>
            ...
            <x-input-text id="email" name="email" title="Email" type="text" placeholder="example@email.com" />
            <x-input-select id="group_id" name="group_id" title="Group" placeholder="Select Group"
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr class="{{ $loop->index % 2 === 0 ? 'bg-gray-100 dark:bg-gray-900' : '' }}">
                                ...
                                <td class="px-4 py-4">
                                    <div class="flex items-center justify-center space-x-3">
                                        <button wire:click="edit({{ $customer->id }})" class="text-info"><i
                                                class="ri-edit-circle-line"></i></button>
                                        <button wire:click="deleteAlert({{ $customer->id }})" class="text-danger"><i
                ...
                @else
                    <div class="text-center">
                        ...
                        <p class="my-5 text-base">No Customer Found</p>
                    </div>
                @endif
            </table>
        </div>
