...
<div class="p-6 border">
    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
        <thead>
            <tr>
                <th scope="col" class="px-2 py-2 text-sm font-medium text-center text-gray-500">No</th>
                <th scope="col" class="px-2 py-2 text-sm font-medium text-gray-500 text-start">Name</th>
                <th scope="col" class="px-2 py-2 text-sm font-medium text-gray-500 text-start">Color</th>
                <th scope="col" class="px-2 py-2 text-sm font-medium text-gray-500 text-start">Size</th>
                <th scope="col" class="px-2 py-2 text-sm font-medium text-gray-500 text-start">Price</th>
                <th scope="col" class="px-2 py-2 text-sm font-medium text-gray-500 text-start">Qty</th>
                <th scope="col" class="px-2 py-2 text-sm font-medium text-gray-500 text-start">Total Price</th>
            </tr>
        </thead>
