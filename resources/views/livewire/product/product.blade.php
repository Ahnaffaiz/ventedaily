        ...
        <div class="flex items-center justify-between p-4 d">
            <div class="flex">
                @if (auth()->user()->canAny(['Create Product', 'Update Product']))
                    ...
                    <div class="ms-2">
                        <button wire:click="exportProductStock" wire:loading.attr="disabled" class="text-sm text-white btn bg-success">
                            <div wire:loading.remove wire:target="exportProductStock">
                                Export
                            </div>
                            <div wire:loading wire:target="exportProductStock" class="inline-flex items-center">
                                <svg class="w-4 h-4 my-0.5 text-white ms-2 animate-spin -ms-1 me-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
