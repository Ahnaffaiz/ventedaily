<div>
    ...
    <div class="grid gap-6 mt-6 xl:grid-cols-2 lg:grid-cols-2">
        <div class="col-xl-6 col-lg-12">
            <div class="h-56 overflow-auto card">
                <div class="sticky top-0 z-10 flex items-center justify-between bg-gray-200 card-header dark:bg-gray-800">
                    <h4 class="card-title">Transfer to Store 14 Juni 2025</h4>
                    <button class="inline gap-2 text-white transition-all btn btn-sm bg-primary" wire:click="transferProduct14Juni('store')">
                        Transfer 14 Juni
                    </button>
                </div>

                <table class="w-full">
                    @if ($transferToStoreJunis)
                        <thead
                            class="sticky bg-gray-200 border-b border-gray-100 dark:bg-gray-800 dark:border-b-gray-700 top-12 z-5">
                            <tr>
                                <th class="w-1/3 p-2 text-start">Product</th>
        ...
        <div class="col-xl-6 col-lg-12">
            <div class="h-56 overflow-auto card">
                <div class="sticky top-0 z-10 flex items-center justify-between bg-gray-200 card-header dark:bg-gray-800">
                    <h4 class="card-title">Transfer to Home 14 Juni 2025</h4>
                    <button class="inline gap-2 text-white transition-all btn btn-sm bg-primary" wire:click="transferProduct14Juni('home')">
                        Transfer 14 Juni
                    </button>
                </div>

                <table class="w-full">
                    @if ($transferToHomeJunis)
                        <thead
                            class="sticky bg-gray-200 border-b border-gray-100 dark:bg-gray-800 dark:border-b-gray-700 top-12 z-5">
                            <tr>
                                <th class="w-1/3 p-2 text-start">Product</th>
