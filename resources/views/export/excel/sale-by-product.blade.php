<table>
    <thead>
        ...
        <tr>
            <td width="20px"></td>
            <td style="font-size:16px; font-weight:500;">LAPORAN PENJUALAN PRODUK {{ $product ? strtoupper($product->name) : '' }}</td>
        </tr>
        <tr>
            <td width="20px"></td>
...
<table>
    <thead>
        <tr>
            ...
            <th style="border: 1px solid black; text-align:center">Net sales</th>
        </tr>
    </thead>
    <tbody>
        @foreach ($products as $product)
            <tr>
                ...
                <td style="border: 1px solid black; width: 100px;">Rp. {{ number_format($product['net_sale'], '0', ',', '.') }}</td>
            </tr>
        @endforeach
    </tbody>
    <tfoot>
        <tr>
            ...
            <td style="border: 1px solid black; font-weight: bold;">Rp. {{ number_format($products->sum('net_sale'), '0', ',', '.') }}</td>
        </tr>
    </tfoot>
</table>
